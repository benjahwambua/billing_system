...
if($_SERVER['REQUEST_METHOD']==='POST'){
 ...
 if(!$errors){
  ...
  if(!$stmt)$errors[]='Unable to prepare plan: '.$conn->error;
   ...
   $stmt->bind_param('isssssdsiss',$tenantId,$planCode,$d['name'],$d['download_speed'],$d['upload_speed'],$d['unit'],$price,$d['billing_cycle'],$days,$d['mikrotik_profile'],$d['data_limit']);
